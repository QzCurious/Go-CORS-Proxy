...
ADR-0019 supersedes this decision's separate cross-process CA Mutation Lease and CA command serialization requirements while retaining its immutable generation, atomic marker, rotation, cleanup, and runtime-generation decisions.
